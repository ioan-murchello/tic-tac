const GameOver = ({ winner, restart }) => {
  return (
    <div className="w-full h-full sm:h-3/4 sm:w-2/4 font-['Montserrat'] bg-gray-100 absolute left-0 right-0 top-0 sm:top-20 mx-auto rounded-xl flex shrink-0 grow-0 gap-y-5 flex-col justify-center items-center game-over">
