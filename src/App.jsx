...
function App() {
  ...
  return (
    <>
      ...
      <div className='glass flex gap-y-16 flex-col justify-center items-center h-screen p-5'>
                ...
                <ol className='flex gap-3'>
                  {el.map((item, colIndex) => {
                    return (
                      <li key={colIndex}>
                        <button
                          className='w-16 h-16 sm:w-20 sm:h-20 flex capitalize justify-center items-center bg-black/70 text-2xl sm:text-5xl text-white cursor-pointer'
